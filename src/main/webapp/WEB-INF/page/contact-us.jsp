    	...
    	<div class="inner">
            ...
            <div class="styles">
                <ul>
                    ...
                    <li><a href="contact-us.html?style=style1" rel="styles1" class="styleswitch red">&nbsp;</a></li>
                    <li><a href="contact-us.html?style=style2" rel="styles2" class="styleswitch blue">&nbsp;</a></li>
                    <li><a href="contact-us.html?style=style3" rel="styles3" class="styleswitch gray">&nbsp;</a></li>
                    <li><a href="contact-us.html?style=style4" rel="styles4" class="styleswitch orange">&nbsp;</a></li>
                    <li><a href="contact-us.html?style=style5" rel="styles5" class="styleswitch green">&nbsp;</a></li>
                    <li><a href="contact-us.html?style=style6" rel="styles6" class="styleswitch orange-red">&nbsp;</a></li>
                </ul>
            </div>
            <!-- Styleswitcher End -->
                    ...
                    <div class="navigation">
                    	<div id="smoothmenu1" class="ddsmoothmenu">
                            <ul>
                                ...
                                <li class="current-menu-item"><a href="contact-us.html">Contact Us</a></li>
    ...
    <div id="contentsec">
    	<div class="inner">
        	...
        	<div class="fullwidth box left">
            	<h3 class="widget-head-border colr">Contact Us</h3>
            	<!-- Contact Us Start -->
                <div class="contact-us">
                	<!-- Half Page Section Start -->
                	<div class="halfpage">
                    	<!-- Content Section Start -->
                    	<div class="contact-text">
                            <h2>Lorem ipsum dolor sit amet, consectetur adipiscing elit Pellentesque semper tristique nulla.</h2>
                            <p>
                        ...
                        <!-- Our Team Start -->
                        <div class="ourteam">
                        	<h3 class="colr">Our Team</h3>
                            <ul>
                            	<li><a href="#"><img src="images/staff1.jpg" alt="" /></a></li>
                                <li><a href="#"><img src="images/staff2.jpg" alt="" /></a></li>
                                <li><a href="#"><img src="images/staff3.jpg" alt="" /></a></li>
                                <li><a href="#"><img src="images/staff4.jpg" alt="" /></a></li>
                                <li><a href="#"><img src="images/staff5.jpg" alt="" /></a></li>
                            </ul>
                        </div>
                        <!-- Our Team End -->
                        <!-- Content Form Start -->
                    ...
                    <!-- Half Page Section End -->
                    <!-- Half Page Section Start -->
                    <div class="halfpage">
                    	<!-- Content Section Start -->
                    	<div class="contact-text">
                            <h3 class="colr">Find Us on Google Map</h3>
                            <h4>Search Our Worldwide Offices on Google Map</h4>
                            <p>
                            	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque semper tristique nulla at ullamcorper. Duis nec lorem ligula, non volutpat neque. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque semper tristique nulla at ullamcorper. Duis nec lorem ligula, non volutpat neque.
                            </p>
                        </div>
                        <!-- Content Section Ends -->
                        <!-- Contact Map Start -->
                        <div class="cont-map">
                        	<iframe width="100%" height="284" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=london&amp;aq=&amp;sll=37.0625,-95.677068&amp;sspn=48.956293,107.138672&amp;ie=UTF8&amp;hq=&amp;hnear=London,+United+Kingdom&amp;ll=51.508129,-0.128005&amp;spn=0.002381,0.006539&amp;t=m&amp;z=14&amp;output=embed"></iframe>
                        </div>
                        <!-- Contact Map End -->
                        <div class="clear"></div>
                        <!-- Addresses Start -->
                        <div class="addresses">
                            ...
                            <div class="address left">
                                <h3 class="colr">Newyork</h3>
                                <p class="bold">
                                    1234 12th St. loiuce StreetNW<br /> 3rd Floor St No 1 Newyork<br /> NY 12345
                                </p>
                                <ul>
                                    <li class="phone">(900) 1-234-567-8910</li>
                                    <li class="mailinfo">info@Identitiy.com</li>
                                    <li class="fax">(+1) 1-234-567-8910</li>
                                </ul>
                            </div>
                            <!-- Address End -->
                            <!-- Address Start -->
                            <div class="address right">
                                <h3 class="colr">London</h3>
                                <p class="bold">
                                    1234 12th St. loiuce StreetNW<br /> 3rd Floor St No 1 Newyork<br /> NY 12345
                                </p>
                                <ul>
                        ...
                        <!-- Content Section Start -->
                        <div class="contact-text">
                            <h3 class="colr">Donate For Kids</h3>
                            <p>
                            	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque semper tristique nulla at ullamcorper. Duis nec lorem ligula, non volutpat neque.
                            </p>
