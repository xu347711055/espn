    	...
    	<div class="inner">
            ...
            <div class="styles">
                <ul>
                    ...
                    <li><a href="events-calendar.html?style=style1" rel="styles1" class="styleswitch red">&nbsp;</a></li>
                    <li><a href="events-calendar.html?style=style2" rel="styles2" class="styleswitch blue">&nbsp;</a></li>
                    <li><a href="events-calendar.html?style=style3" rel="styles3" class="styleswitch gray">&nbsp;</a></li>
                    <li><a href="events-calendar.html?style=style4" rel="styles4" class="styleswitch orange">&nbsp;</a></li>
                    <li><a href="events-calendar.html?style=style5" rel="styles5" class="styleswitch green">&nbsp;</a></li>
                    <li><a href="events-calendar.html?style=style6" rel="styles6" class="styleswitch orange-red">&nbsp;</a></li>
                </ul>
            </div>
            <!-- Styleswitcher End -->
