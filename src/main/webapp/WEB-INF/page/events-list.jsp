    	...
    	<div class="inner">
            ...
            <div class="styles">
                <ul>
                    ...
                    <li><a href="events-list.html?style=style1" rel="styles1" class="styleswitch red">&nbsp;</a></li>
                    <li><a href="events-list.html?style=style2" rel="styles2" class="styleswitch blue">&nbsp;</a></li>
                    <li><a href="events-list.html?style=style3" rel="styles3" class="styleswitch gray">&nbsp;</a></li>
                    <li><a href="events-list.html?style=style4" rel="styles4" class="styleswitch orange">&nbsp;</a></li>
                    <li><a href="events-list.html?style=style5" rel="styles5" class="styleswitch green">&nbsp;</a></li>
                    <li><a href="events-list.html?style=style6" rel="styles6" class="styleswitch orange-red">&nbsp;</a></li>
                </ul>
            </div>
            <!-- Styleswitcher End -->
    	...
    	<div class="inner">
        	<div class="fullwidth left">
                ...
                <div class="fullwidth box left">
                    <h2 class="widget-head-border colr">Events Listing</h2>
                    <!-- Event List Start -->
                    <div class="events-list"> 
                        ...
                        <div class="single-date-event"> <span class="eve-pointer">&nbsp;</span> 
                            ...
                            <div class="single-event">
                                <div class="event-date"> <span>05</span> <span>JUL</span> </div>
                                <div class="event-sec">
                                    <div class="event-box">
                                        <div class="event-conts">
                                            ...
                                            <p class="txt"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque elementum enim ut est volutpat consequat. Nunc ornare molestie urna ac blandit. Phasellus sollicitudin orci sit amet dolor accumsan eu fermentum eros consequat. </p>
                                        </div>
                                        <div class="location"> <a href="javascript:animatedcollapse.toggle('location-1')">Conference Center Auditorium</a>
                            ...
                            <div class="single-event">
                                <div class="event-sec">
                                    <div class="event-box">
                                        ...
                                        <div class="location"> <a href="javascript:animatedcollapse.toggle('location-2')">Conference Center Auditorium</a>
                            ...
                            <div class="single-event">
                                ...
                                <div class="event-sec">
                                    <div class="event-box">
                                        ...
                                        <div class="location"> <a href="javascript:animatedcollapse.toggle('location-3')">Conference Center Auditorium</a>
                            ...
                            <div class="single-event">
                                ...
                                <div class="event-sec">
                                    <div class="event-box">
                                        ...
                                        <div class="location"> <a href="javascript:animatedcollapse.toggle('location-4')">Conference Center Auditorium</a>
                            ...
                            <div class="single-event">
                                ...
                                <div class="event-sec">
                                    <div class="event-box">
                                        ...
                                        <div class="location"> <a href="javascript:animatedcollapse.toggle('location-5')">Conference Center Auditorium</a>
