    	...
    	<div class="inner">
            ...
            <div class="styles">
                <ul>
                    ...
                    <li><a href="gallery-grid.html?style=style1" rel="styles1" class="styleswitch red">&nbsp;</a></li>
                    <li><a href="gallery-grid.html?style=style2" rel="styles2" class="styleswitch blue">&nbsp;</a></li>
                    <li><a href="gallery-grid.html?style=style3" rel="styles3" class="styleswitch gray">&nbsp;</a></li>
                    <li><a href="gallery-grid.html?style=style4" rel="styles4" class="styleswitch orange">&nbsp;</a></li>
                    <li><a href="gallery-grid.html?style=style5" rel="styles5" class="styleswitch green">&nbsp;</a></li>
                    <li><a href="gallery-grid.html?style=style6" rel="styles6" class="styleswitch orange-red">&nbsp;</a></li>
                </ul>
            </div>
            <!-- Styleswitcher End -->
    ...
    <div id="contentsec">
    	<div class="inner">
        	...
        	<div class="fullwidth box left">
            	<h3 class="widget-head-border colr">Image Gallery</h3>
            	<!-- Gallery Section Start -->
                <div class="gallery-sec">
                	<!-- Gallery Filter Buttons Start -->
                	<div class="gallery-filter">
                    	<p class="total-pics">Total 89 Photos</p>
                        <div class="right">
                            <div class="filter">
                            	<ul id="filterOptions">
                            		<li class="active"><a href="#" class="all">All</a></li>
                                    <li><a href="#" class="anim">Animation</a></li>
                    ...
                    <ul class="gallery-grid ourHolder">
                    	<li class="item" id="id-1" value="anim">
                        	<a href="#"><img src="images/gallery1.jpg" alt="" /></a>
                            <div class="thumb-hover">
                            	<h3><a href="#" class="white">Image Name</a></h3>
                                <p>Forest Gump once said you can tell a lot about a person by</p>
                        ...
                        <li class="item" id="id-2" value="brand">
                        ...
                        <li class="item" id="id-3" value="videos">
                        ...
                        <li class="item" id="id-4" value="anim">
                        ...
                        <li class="item" id="id-5" value="brand">
                        ...
                        <li class="item" id="id-6" value="videos">
                        ...
                        <li class="item" id="id-7" value="anim">
                        	<a href="#"><img src="images/gallery7.jpg" alt="" /></a>
                            <div class="thumb-hover">
                            	<h3><a href="#" class="white">Image Name</a></h3>
                                <p>Forest Gump once said you can tell a lot about a person by</p>
                                <div class="thumb-actions">
                        ...
                        <li class="item" id="id-8" value="brand">
                        	<a href="#"><img src="images/gallery8.jpg" alt="" /></a>
                            <div class="thumb-hover">
                            	<h3><a href="#" class="white">Image Name</a></h3>
                                <p>Forest Gump once said you can tell a lot about a person by</p>
                                <div class="thumb-actions">
                        ...
                        <li class="item" id="id-9" value="videos">
                        	<a href="#"><img src="images/gallery9.jpg" alt="" /></a>
                            <div class="thumb-hover">
                            	<h3><a href="#" class="white">Image Name</a></h3>
                                <p>Forest Gump once said you can tell a lot about a person by</p>
                                <div class="thumb-actions">
                        ...
                        <li class="item" id="id-10" value="anim">
                        	<a href="#"><img src="images/gallery10.jpg" alt="" /></a>
                            <div class="thumb-hover">
                            	<h3><a href="#" class="white">Image Name</a></h3>
                                <p>Forest Gump once said you can tell a lot about a person by</p>
                                <div class="thumb-actions">
                        ...
                        <li class="item" id="id-11" value="brand">
                        	<a href="#"><img src="images/gallery11.jpg" alt="" /></a>
                            <div class="thumb-hover">
                            	<h3><a href="#" class="white">Image Name</a></h3>
                                <p>Forest Gump once said you can tell a lot about a person by</p>
                                <div class="thumb-actions">
                        ...
                        <li class="item" id="id-12" value="videos">
                        	<a href="#"><img src="images/gallery12.jpg" alt="" /></a>
                            <div class="thumb-hover">
                            	<h3><a href="#" class="white">Image Name</a></h3>
                                <p>Forest Gump once said you can tell a lot about a person by</p>
                                <div class="thumb-actions">
