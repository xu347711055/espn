    	...
    	<div class="inner">
            ...
            <div class="styles">
                <ul>
                    ...
                    <li><a href="sermons.html?style=style1" rel="styles1" class="styleswitch red">&nbsp;</a></li>
                    <li><a href="sermons.html?style=style2" rel="styles2" class="styleswitch blue">&nbsp;</a></li>
                    <li><a href="sermons.html?style=style3" rel="styles3" class="styleswitch gray">&nbsp;</a></li>
                    <li><a href="sermons.html?style=style4" rel="styles4" class="styleswitch orange">&nbsp;</a></li>
                    <li><a href="sermons.html?style=style5" rel="styles5" class="styleswitch green">&nbsp;</a></li>
                    <li><a href="sermons.html?style=style6" rel="styles6" class="styleswitch orange-red">&nbsp;</a></li>
                </ul>
            </div>
            <!-- Styleswitcher End -->
    ...
    <div id="contentsec">
    	<div class="inner">
            ...
            <div class="twothird box left">
            	<h2 class="widget-head-border colr">Available Sermons</h2>
                <div class="sermons">
                    <!-- Sermon Start -->
                    <div class="sermons-post">
                        ...
                        <div class="post-sec">
                            <h4 class="post-head"><a href="#">The Immutability of God</a></h4>
                            <p>
                            	<span>Speaker: Mark Vroegop</span>
                            	<span>Series: 6:17-19</span>
                            </p>
                        </div>
                        <div class="sermons-opts">
                        	<a href="#" class="audio"><span>Listen</span></a>
                            <a href="#" class="video"><span>Watch</span></a>
                            <a href="#" class="download"><span>Download</span></a>
                            <a href="#" class="app-guide"><span>Application&nbsp;Guide</span></a>
                            <a href="#" class="manu-script"><span>Manu&nbsp;Script</span></a>
                        </div>
                    </div>
                    <!-- Sermon End -->
                    <!-- Sermon Start -->
                    <div class="sermons-post">
                        ...
                        <div class="post-sec">
                            <h4 class="post-head"><a href="#">Capitalizing On Our Contacts</a></h4>
                            <p>
                            	<span>Speaker: Mark Vroegop</span>
                            	<span>Series: 6:17-19</span>
                            </p>
                    ...
                    <div class="sermons-post">
                        ...
                        <div class="post-sec">
                            <h4 class="post-head"><a href="#">The Great Omission or the Great Commission</a></h4>
                            <p>
                            	<span>Speaker: Mark Vroegop</span>
                            	<span>Series: 6:17-19</span>
                            </p>
                    ...
                    <div class="sermons-post">
                        ...
                        <div class="post-sec">
                            <h4 class="post-head"><a href="#">The Father Who Takes Us the Rest of the Way</a></h4>
                            <p>
                            	<span>Speaker: Mark Vroegop</span>
                            	<span>Series: 6:17-19</span>
                            </p>
